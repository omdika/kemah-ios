...
> **Version:** 1.2.0 — see [`CHANGELOG.md`](./CHANGELOG.md) for history. Older snapshots live under [`versions/`](./versions/). The visual reference prototype is in [`reference/`](./reference/).
